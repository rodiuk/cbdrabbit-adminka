...
import { PromoCodeSchema, PromoCodeType } from "../AddNewPromoCode/schema";
...
export const EditPromoCodeForm = ({
  onSubmit,
  isLoading,
  promoCode,
  ...
  const {
    ...
    defaultValues: {
      isActive: promoCode.iasActive,
      percentDiscount: promoCode.percentDiscount!,
      newPrice: promoCode.newPrice!,
      code: promoCode.code,
      type: promoCode.percentDiscount ? "percent" : "fixed",
    },
  });
